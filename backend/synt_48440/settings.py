"""
Django settings for synt_48440 project.
...
WSGI_APPLICATION = 'synt_48440.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "synt Support <support@synt-48440.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "synt_48440 API",
    "DESCRIPTION": "API documentation for synt_48440 App",
    "VERSION": "v1",
}
